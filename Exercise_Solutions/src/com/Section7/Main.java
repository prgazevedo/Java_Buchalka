...
public class Main {
    ...
    private static void testRoom(){
        ...
        Room bedRoom = new Bedroom(bedRoomDimension, bedRoomwindow, bedRoomDoor, bed, lamp, closet);

        ((Bedroom) bedRoom).getCloset().getClosetDoor().setOpen(true);
        ((Bedroom) bedRoom).getLamp().setOn(true);
